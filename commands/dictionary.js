...
module.exports = {
    ...
    async execute(message, args) {
        try {
            if (!args[1]) return message.channel.send("Please specify a word to search");
            ...
            console.log(err);
            message.channel.send("There has been an error. Please check your spelling. Words in other languages don't work")
        }
